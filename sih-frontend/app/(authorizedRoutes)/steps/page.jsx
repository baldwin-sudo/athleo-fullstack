  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {user ? (
        ...
        <div className="bg-gray-100 rounded-lg p-6 text-center">
          <p className="text-gray-600">
            Connect to Google Fit to view your step count data, or use simulated
            data for testing
          </p>
        </div>
      )}
      ...
      <div className="mt-12 bg-blue-50 rounded-lg p-6">
        ...
        <p className="mb-4">
          This feature allows you to track your daily steps using data from
          Google Fit. Connect your Google account to see your step count for the
          last 7 days.
        </p>
        <p>
          Your data is only used for display purposes and is not stored on our
          servers.
        </p>
        {isSimulated && (
          <div className="mt-4 bg-yellow-100 p-3 rounded">
            <p className="text-yellow-800 text-sm">
              <strong>Note:</strong> You are currently viewing simulated data
